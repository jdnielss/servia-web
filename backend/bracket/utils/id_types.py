...
PadelMatchId = NewType("PadelMatchId", int)
PadelMatchPlayerId = NewType("PadelMatchPlayerId", int)
PadelMatchRoundId = NewType("PadelMatchRoundId", int)
PadelMatchGameId = NewType("PadelMatchGameId", int)
