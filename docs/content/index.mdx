...
[Casa Familia Padel Club](https://github.com/evroon/bracket) is a tournament system meant to be easy to use. Casa Familia Padel Club
...
There are plenty of tournament systems to be found online. So why does Casa Familia Padel Club exist?
...
one, I will list it here as alternative to Casa Familia Padel Club. Furthermore, the closed-source tournament
...
To get started in selfhosting Casa Familia Padel Club, follow the steps described
in [quickstart](/docs/running-bracket/quickstart.mdx).

To learn how to organize a tournament in Casa Familia Padel Club, read the [usage guide](/docs/usage/guide.mdx).
