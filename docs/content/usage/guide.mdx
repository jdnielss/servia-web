...
Setting up a tournament in a tournament management system like Casa Familia Padel Club typically involves several
key steps. Below is a general guide on how to set up a tournament step-by-step.

<Callout type="info">
This guide assumes you are logged in to Casa Familia Padel Club. This guide also assumes you use the demo of Casa Familia Padel Club
(`https://www.bracketapp.nl`). If you are selfhosting Casa Familia Padel Club, just use your own domain instead.
</Callout>
...
- **Allow anyone to see the dashboard of rounds and matches:** Whether the dashboard is publicly
  accessible
- **Allow players to be in multiple teams**: Usually players are only part of one team and Casa Familia Padel Club
...
Now, decide on the format of your tournament. Casa Familia Padel Club currently supports:
...
you need to do in Casa Familia Padel Club, everything should be set up by now.
