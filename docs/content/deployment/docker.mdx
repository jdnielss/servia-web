...
This section describes how to deploy Casa Familia Padel Club (frontend and backend) to docker using docker-compose.
...
Casa Familia Padel Club needs two volume bindings: for the backend and for the database.
...
Access Casa Familia Padel Club at `http://localhost:3000`.
