  ...
  return (
    <footer id="footer">
      ...
      <section className="container py-20 grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-x-12 gap-y-8">
        <div className="col-span-full xl:col-span-2">
          <Link href="/" className="font-bold text-xl flex">
            <Image
              ...
              src={logo.src}
              className="mr-2"
              alt="Logo of Casa Familia Padel Club"
            />
            <b className="text-3xl">Casa Familia Padel Club</b>
          </Link>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <h3 className="font-bold text-lg">Running Casa Familia Padel Club</h3>
          <div>
            <Link
      ...
      <section className="container pb-14 text-center">
        <h3>
          Casa Familia Padel Club - Open-source Tournament System.
          <br />
          Licensed under AGPL-v3.0. Copyright © {new Date().getFullYear()}{" "}
          Casa Familia Padel Club. Built with Nextra.
        </h3>
      </section>
    </footer>
  );
